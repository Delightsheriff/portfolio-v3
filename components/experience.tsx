...
export default function Experiences({
  ...
  return (
    <>
      <section id="experience" className="py-20 md:py-32 px-6 md:px-8 bg-muted">
              ...
              <ScrollReveal key={experience._id} delay={index * 0.1}>
                <div className="grid grid-cols-12 gap-4 md:gap-8 group">
                  ...
                  <div className="col-span-12 md:col-span-8 md:col-start-5">
                    <div className="bg-card p-6 md:p-8 rounded-sm border border-border group-hover:border-primary/20 group-hover:shadow-lg transition-all duration-300">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {experience.technologies.map((tech, i) => (
                              <span
                                key={i}
                                className="px-3 py-1 bg-muted text-xs font-mono rounded-full"
                              >
                                {tech}
                              </span>
                            ))}
